  ...
  return (
    <motion.section className={`relative`}>
      <div className={` md:h-screen padding-x py-5 flex flex-col`}>
        ...
        <div
          className='relative flex gap-10 w-full h-full md:overflow-hidden'>
          <div
            ref={containerRef}
          ...
          <div className={`md:inline hidden flex-1`}>
            {selectWork === -1
              ? <div className='grid place-items-center h-full'><h2 className='text-5xl'>Select one project</h2></div>
